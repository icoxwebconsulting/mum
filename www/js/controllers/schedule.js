...
//        console.log('scroll to day', $ionicPosition.position(angular.element(document.getElementsByClassName('calendar-day clear-btn flex-xs active'))));
    ...
    $scope.select = function (day) {
        ...
        console.info('$scope.selected', moment($scope.selected).format(DATETIME_FORMAT_CONF.dateTimeFormat));
        console.info('moment()', moment().format(DATETIME_FORMAT_CONF.dateTimeFormat));
