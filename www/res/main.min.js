...
angular.module('app', ['ionic', 'app.routes', 'app.userDataStore', 'app.user', 'app.pushNotification', 'app.messageNotification',
        'app.resources', 'app.messageResource', 'app.device', 'app.contactRes', 'app.deviceDataStore', 'app.messageReceived',
...
angular.module('app')
    ...
    .constant("APP_STORE_CONF", {
        webStore: true
    })
    .constant("DATETIME_FORMAT_CONF", {
        dateTimeFormat : "YYYY-MM-DD HH:MM:SS"
    })
    .constant("SERVER_CONF", {
        //HOST: "http://localhost/app_dev.php/",
        //API_HOST: "http://localhost/app_dev.php/api/v1/"

        HOST: "http://192.168.1.136/app_dev.php/",
        API_HOST: "http://192.168.1.136/app_dev.php/api/v1/"

        //HOST: "http://mum.icox.mobi/framework/web/app_dev.php/",
        //API_HOST: "http://mum.icox.mobi/framework/web/app_dev.php/api/v1/"
    })
    .constant("OAUTH_CONF", {
        //OAUTH_HOST: "http://localhost/app_dev.php/oauth/v2/",

        OAUTH_HOST: "http://192.168.1.136/app_dev.php/oauth/v2/",

        //OAUTH_HOST: "http://mum.icox.mobi/framework/web/app_dev.php/oauth/v2/",


        CLIENT_ID: "56e0d9f1ab30c_3cqw9qtnxxog4gwgkog88k8g0o4ogkcswckskwo8okcwwk08ck",
        CLIENT_SECRET: "58calox4u288owcccck48ws4ogg88sw88oo4ss0kwow4cgs4so",
...
angular.module('app').service('messageQueue', function (messageRes, $q, messageStorage, userDatastore, messageNotification) {
    ...
    function addSms(msg) {
        console.log("MSG", msg);
        //messageStorage.savePendingMessage(msg, 'sms', msg.idConversation).then(function (params) {
        //    processSms();
        //});
        smsQueue.push(msg);
    }
